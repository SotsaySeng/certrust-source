...
This document describes the implementation of the fresh install script for the Certrust project, addressing [GitHub Issue #57](https://github.com/Schroedinger-Hat/certo/issues/57).

## Overview

The fresh install script provides a complete setup for a new Certrust Strapi instance, including:
...
- **Email**: `issuer@certrust.dev`
- **Profile Type**: Issuer
- **DID**: Generated using `did:web:certrust-demo.org` format
- **URL**: `https://certrust-demo.org`
- **Description**: Sample issuer organization for demonstration

### 3. Issuer User
- **Email**: `issuer@certrust.dev` (same as issuer profile)
- **Password**: `Issuer123!`
...
docker exec -it certrust_backend npm run test-fresh-install
```
...
- **Admin**: `admin@certrust.dev` / `Admin123!`
- **Issuer**: `issuer@certrust.dev` / `Issuer123!`
