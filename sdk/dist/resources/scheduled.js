export class ScheduledResource {
    ...
    list(params) {
        ...
        return this.http.get(`/api/scheduled-issuances${query}`);
    }
    /**
     ...
     */
    get(id) {
        return this.http.get(`/api/scheduled-issuances/${id}`);
    }
    /**
     ...
     */
    create(input) {
        return this.http.post('/api/scheduled-issuances', {
            data: {
     ...
     */
    cancel(id) {
        return this.http.put(`/api/scheduled-issuances/${id}`, { data: { status: 'cancelled' } });
    }
}
