...
/**
 * Fresh Install Script for Certrust Strapi Backend
 * 
...
const CONFIG = {
  admin: {
    ...
    // the same admin credentials. The issuer user (issuer@certrust.dev/
  ...
  try {
    ...
    const issuerProfile = await strapi.query('api::profile.profile').create({
      data: {
        ...
        did: `did:web:certrust-demo.org:${generateRandomString(16)}`,
        ...
        proof: [
          {
            ...
            verificationMethod: `did:web:certrust-demo.org:${generateRandomString(16)}#key-1`,
...
async function runFreshInstall() {
  console.log('🚀 Starting Certrust Fresh Install...');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
