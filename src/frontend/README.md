# Certrust Frontend (Nuxt 3 + Una UI)

This is the Nuxt 3 (Vue 3 + Una UI) implementation of the Certrust frontend for managing digital credentials and badges using the Open Badges standard.
...
- NPM or Yarn
- A running Certrust backend (Strapi) instance
