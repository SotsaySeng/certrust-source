...
<template>
  <div class="bg-white/80 backdrop-blur-lg rounded-2xl p-8 shadow-lg">
    ...
    <div class="flex justify-center mb-6 gap-4">
      <button
        type="button"
        class="px-4 py-2 rounded-full text-sm font-medium transition-colors" :class="[verifyMode === 'id' ? 'bg-[#28A745] text-black' : 'bg-gray-100 text-text-secondary hover:text-text-primary']"
      ...
      <button
        type="button"
        class="px-4 py-2 rounded-full text-sm font-medium transition-colors" :class="[verifyMode === 'json' ? 'bg-[#28A745] text-black' : 'bg-gray-100 text-text-secondary hover:text-text-primary']"
    ...
    <form class="space-y-6" @submit.prevent="handleVerify">
      ...
      <div v-if="verifyMode === 'json'">
        ...
        <div class="flex flex-col items-center justify-center px-6 py-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-[#28A745] transition-colors">
          ...
          <label class="relative cursor-pointer rounded-md font-medium text-[#28A745] hover:text-[#28A745]/80 focus-within:outline-none">
      ...
      <div>
        <button
          ...
          class="w-full flex justify-center py-2 px-4 border border-transparent rounded-full shadow-sm text-black bg-[#28A745] hover:bg-[#28A745]/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#28A745] disabled:opacity-50 disabled:cursor-not-allowed"
        >
