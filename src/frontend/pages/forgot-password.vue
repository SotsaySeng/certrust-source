...
const pageDescription = ref('Reset your Certrust account password')
...
<template>
  <div class="bg-gradient-to-b from-white to-[#D9F2DE]/20 flex items-center justify-center py-8 px-4 sm:px-6 lg:px-8 h-full flex-grow-1">
