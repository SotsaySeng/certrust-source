...
const pageDescription = ref('Set a new password for your Certrust account.')
...
<template>
  <div class="min-h-screen bg-gradient-to-b from-white to-[#D9F2DE]/20 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
