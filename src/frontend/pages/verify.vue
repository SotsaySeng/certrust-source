...
const { t } = useI18n()
const pageDescription = ref('Verify your badges with Certrust')
const faqs = ref([
  {
  ...
  },
  {
    ...
    answer: 'You can verify any digital certificate issued through Certrust, including Open Badges 3.0 and other compatible verifiable credentials. We support various formats to ensure compatibility with different certification standards.',
    isOpen: false
  },
  {
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="bg-white/80 backdrop-blur-lg rounded-2xl p-6 shadow-lg">
            <div class="w-12 h-12 bg-[#28A745]/10 rounded-full flex items-center justify-center mb-4">
              <div class="w-6 h-6 i-heroicons-cube-transparent text-[#28A745]" />
            </div>
          ...
          <div class="bg-white/80 backdrop-blur-lg rounded-2xl p-6 shadow-lg">
            <div class="w-12 h-12 bg-[#28A745]/10 rounded-full flex items-center justify-center mb-4">
              <div class="w-6 h-6 i-heroicons-bolt text-[#28A745]" />
            </div>
            <h3 class="text-lg font-medium text-text-primary mb-2">
              Instant Results
            </h3>
          ...
          <div class="bg-white/80 backdrop-blur-lg rounded-2xl p-6 shadow-lg">
            <div class="w-12 h-12 bg-[#28A745]/10 rounded-full flex items-center justify-center mb-4">
              <div class="w-6 h-6 i-heroicons-document-duplicate text-[#28A745]" />
            </div>
            <h3 class="text-lg font-medium text-text-primary mb-2">
              Multiple Formats
            </h3>
        ...
        <div class="max-w-3xl mx-auto space-y-4">
          ...
          >
            ...
            >
              ...
              >
                <div class="w-5 h-5 i-heroicons-chevron-down text-[#28A745]" />
              </div>
            </button>
            <div
              v-show="faq.isOpen"
