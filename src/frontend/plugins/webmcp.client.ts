/**
 * WebMCP plugin — exposes Certrust's key actions to AI agents via the browser's
  ...
  ctx.provideContext({
    tools: [
      ...
      },
      {
        ...
        description: 'List all available achievement / badge definitions in this Certrust instance.',
